...
import co.ceiba.config.audit.AuditEventConverter;
import co.ceiba.domain.PersistentAuditEvent;
...
import static co.ceiba.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
