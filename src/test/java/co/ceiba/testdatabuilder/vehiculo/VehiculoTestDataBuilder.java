package co.ceiba.testdatabuilder.vehiculo;
...
public class VehiculoTestDataBuilder {
    ...
    private static final String PLACA = "BCD123";
    private static final TipoVehiculo TIPO = TipoVehiculo.MOTO;
    private static final Integer CILINDRAJE = 100;
    private static final Instant FECHAINGRESO = Instant.parse("2017-11-08T10:12:35Z");
